...
s = replace_once(
    ...
    'For the Consensus-Frequency benchmark, let $T_t=\\operatorname{Top}_{25}(p^t)$ denote the 25 occupations with the largest priorities under scenario $t$. Then $f_i=\\sum_{t=1}^{18}\\ind\\{i\\in T_t\\}$ counts appearances across the 18 scenario-specific Top-25 lists. The 25 largest counts are selected; the cutoff is strict (9 appearances for the 25th occupation versus 8 for the 26th), so no frequency tie occurs at the membership cutoff. Ascending SOC is retained only as a fixed deterministic tie-break for equal counts away from the cutoff. The list overlaps relative minimax in 24/25 occupations: consensus includes Hosts and Hostesses, Restaurant, Lounge, and Coffee Shop (35-9031), whereas minimax includes Amusement and Recreation Attendants (39-3091). Exact scenario-by-scenario capture/regret are retained in the reproducibility addendum. Counts are design occurrences, not probabilities.\n\n\\noindent\\textbf{Consensus-Frequency Top-25 SOC membership.} 11-1021, 13-2011, 29-1141, 35-3031, 37-2011, 41-2011, 41-2031, 41-4012, 43-3031, 43-4171, 43-6014, 43-9061, 53-3032, 53-7065, 13-1111, 43-1011, 13-1071, 15-1232, 33-9032, 35-2014, 35-9031, 41-1011, 43-5071, 43-6013, and 49-9071. The complete labeled list is supplied in \\texttt{consensus\\_frequency\\_selection.csv}. The relative-minimax list contains the same 24 shared occupations, replacing Hosts and Hostesses, Restaurant, Lounge, and Coffee Shop (35-9031) with Amusement and Recreation Attendants (39-3091).',
